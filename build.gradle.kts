...
ignitionModule {
     ...
     */
    name.set("Rapid Dev Tools Mod")

    /*
     * Name of the '.modl' file to be created, without file extension.
     */
    fileName.set("Rapid-Dev-Tools-Mod.modl")
    /*
     ...
     */
    hooks.putAll(mapOf(
        "dev.openscada.rapiddevtoolsmod.gateway.RapidDevToolsModGatewayHook" to "G",
        "dev.openscada.rapiddevtoolsmod.designer.RapidDevToolsModDesignerHook" to "D"
    ))
